...
{
    /// <summary>
    /// Các thiết lập màu sắc tĩnh - Bảng màu phong cách Catppuccin Mocha.
    /// Tất cả màu sắc UI được khai báo ở đây để đồng nhất trên toàn ứng dụng.
    /// </summary>
    public static class AppColors
    {
        ...
        // === HÀM HỖ TRỢ ===
        /// <summary>
        /// Nội suy tuyến tính giữa hai màu sắc.
        /// t = 0.0 → màu A, t = 1.0 → màu B.
        /// </summary>
        ...
        /// <summary>
        /// Trả về một màu nhạt hơn dùng cho các hiệu ứng di chuột (hover/highlight).
        /// </summary>
        ...
        /// <summary>
        /// Trả về một màu tối hơn dùng cho các hiệu ứng nhấn (pressed).
        /// </summary>
